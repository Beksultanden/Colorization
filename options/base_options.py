...
class BaseOptions():
    # класс который отвечает за обработку всех параметров запуска работы, настраиваются модель, датасет, гиперпараметры,
    # GPU, путь сохранения и параметры цветизации
    def __init__(self):
        self.initialized = False

    def initialize(self, parser):
         # Основные параметры обучения и модели
        ...
        # Параметры цветизации пространство Lab 
